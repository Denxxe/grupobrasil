...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-11-2025 a las 03:08:50
...
INSERT INTO `carga_familiar` (`id_carga`, `id_habitante`, `id_jefe`, `parentesco`, `activo`, `fecha_registro`, `fecha_actualizacion`) VALUES
(5, 4, 5, '', 1, '2025-11-03 21:56:56', '2025-11-03 21:56:56');
...
(9, 6, 3, 'wasaaaa', '2025-11-03 22:24:06', 1);
...
INSERT INTO `eventos` (`id_evento`, `titulo`, `descripcion`, `ubicacion`, `fecha`, `hora_inicio`, `hora_fin`, `categoria_edad`, `alcance`, `id_calle`, `creado_por`, `fecha_creacion`, `actualizado_por`, `fecha_actualizacion`, `activo`) VALUES
(1, 'Evento fracata', '', 'Cerro Pan de Azucar Centro Histrico de la ciudad de Cuman San Francisco muy cerca de la Iglesia Santa Ins Cuman', '2025-11-05', '08:27:00', '19:25:00', 'todos', 'comunidad', NULL, 2, '2025-11-03 22:25:53', NULL, NULL, 1);
...
--
-- Volcado de datos para la tabla `habitante_vivienda`
--

INSERT INTO `habitante_vivienda` (`id_habitante`, `id_vivienda`, `es_jefe_familia`, `fecha_inicio`, `fecha_salida`) VALUES
(5, 4, 1, '2025-10-30', NULL);
...
(4, 1, '2025-10-30', 1, '2025-10-30 01:43:55', '2025-10-30 01:43:55'),
(4, 2, '2025-10-30', 1, '2025-10-30 01:43:55', '2025-10-30 01:43:55');
...
(4, 6, 5, '2025-11-03 18:23:09'),
(5, 6, 3, '2025-11-03 18:24:02');
...
(6, 2, 4, 'Si', 'sI', NULL, 'noticia-1762208304', 'publicado', '2025-11-03 18:18:24', '2025-11-03 18:18:24', '2025-11-03 18:18:49');
...
(1, 'Pago de Bombonas', 2, 200.00, '0102\r\n04125432434\r\n123123132', 2, '2025-10-28', '2025-10-30', '2025-10-29 01:24:01', 'cerrado');
...
(3, '14671227', 'Carmen', 'Carvajal', '1980-01-01', 'F', '04248524727', 'Oficina Central', 1, '', 'admin@grupobrasil.com', NULL, 1, '2025-10-20 23:29:39', '2025-10-30 00:06:26'),
(6, '31044092', 'Cristian Jesus', 'Correa Pinto', '0000-00-00', 'M', '04126785678', 'Urbanización Brasil', 1, '2', 'cristiancorreaxd@gmail.com', 'Residente', 1, '2025-10-21 04:48:38', '2025-10-30 01:42:33'),
(7, '87654321', 'Luis', 'Arredondo', '0000-00-00', 'M', '04147852753', '', 1, '1', 'lfarredondot14@gmail.com', 'Residente', 1, '2025-10-21 20:33:17', '2025-10-30 01:43:33'),
(11, '29328392', 'Denilson', 'Cardiet', '0000-00-00', 'M', '04126283726', '', 2, '1', 'denilsonlapara@gmail.com', 'Residente', 1, '2025-10-29 19:02:45', '2025-10-30 01:43:01');
...
(3, 6, 3, NULL, '$2y$10$kqO8xp6ijfL.yMNsd7n8vO2RyrxZndg8wUsi5n2y4JJUPQymWhHMW', 'cristiancorreaxd@gmail.com', '2025-10-21 07:19:28', NULL, 1, '2025-10-30 00:07:10', 'Usuario'),
...
(4, 1, '8', 'Casa', 'Activo', 0, '2025-10-25 23:16:30', '2025-10-30 01:40:48'),
(5, 2, '11', 'Casa', 'Activo', 0, '2025-10-29 19:07:16', '2025-10-30 01:40:53'),
(6, 1, '1', 'Casa', 'Activo', 1, '2025-10-30 01:41:07', '2025-10-30 01:41:07'),
(7, 1, '2', 'Casa', 'Activo', 1, '2025-10-30 01:41:16', '2025-10-30 01:41:16'),
(8, 1, '3', 'Casa', 'Activo', 1, '2025-10-30 01:41:26', '2025-10-30 01:41:26'),
(9, 2, '1', 'Casa', 'Activo', 1, '2025-10-30 01:41:36', '2025-10-30 01:41:36'),
(10, 2, '2', 'Casa', 'Activo', 1, '2025-10-30 01:41:49', '2025-10-30 01:41:49'),
(11, 2, '3', 'Casa', 'Activo', 1, '2025-11-03 18:34:59', '2025-11-03 18:34:59');
...
--
ALTER TABLE `carga_familiar`
  MODIFY `id_carga` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `comentarios`
  MODIFY `id_comentario` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `likes`
  MODIFY `id_like` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `noticias`
  MODIFY `id_noticia` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `notificaciones`
  MODIFY `id_notificacion` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `vivienda`
  MODIFY `id_vivienda` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
