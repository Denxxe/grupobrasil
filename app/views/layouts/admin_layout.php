...
// Generalmente, $content_view se pasa como una variable extraída ($data)
// desde el método renderAdminView del controlador.
...
<body class="h-full flex"
    ...
    <aside id="sidebar" class="sidebar bg-vinotinto-700 text-gray-100 flex flex-col p-4 rounded-r-lg shadow-lg">
        <div class="flex items-center justify-center p-4 border-b border-vinotinto-800 overflow-hidden">
            <h1 class="text-2xl font-bold text-accentgold sidebar-text">AdminPanel</h1>
        </div>
        <nav class="flex-grow mt-4">
            <ul class="space-y-2">
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/dashboard" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-tachometer-alt mr-3 sidebar-icon"></i> <span class="sidebar-text">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/users" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-users mr-3 sidebar-icon"></i> <span class="sidebar-text">Usuarios</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/news" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-newspaper mr-3 sidebar-icon"></i> <span class="sidebar-text">Noticias</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/comments" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-comments mr-3 sidebar-icon"></i> <span class="sidebar-text">Comentarios</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/notifications" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-bell mr-3 sidebar-icon"></i> <span class="sidebar-text">Notificaciones</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/reports" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-chart-line mr-3 sidebar-icon"></i> <span class="sidebar-text">Reportes</span>
                    </a>
                </li>
                <li>
                    <a href="/grupobrasil/public/index.php?route=admin/settings" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
    ...
    <script src="/grupobrasil/public/js/admin_news_scripts.js?v=<?php echo time(); ?>"></script>
    <script src="/grupobrasil/public/js/edit_user_form.js?v=<?php echo time(); ?>"></script>
</body>
</html>