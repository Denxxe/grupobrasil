...
<body class="h-full flex"
    ...
    <aside id="sidebar" class="sidebar bg-vinotinto-700 text-gray-100 flex flex-col p-4 rounded-r-lg shadow-lg">
        ...
        <nav class="flex-grow mt-4">
            <ul class="space-y-2">
                <li>
                    <a href="./index.php?route=admin/dashboard" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
                        <i class="fas fa-tachometer-alt mr-3 sidebar-icon"></i> <span class="sidebar-text">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a href="./index.php?route=admin/users" class="flex items-center px-4 py-2 text-vinotinto-100 hover:bg-vinotinto-600 hover:text-white rounded-md transition duration-200">
