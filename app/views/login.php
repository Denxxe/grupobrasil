...
<body class="bg-light">
  ...
  <div class="d-flex justify-content-center align-items-center min-vh-100 p-3 p-md-0">
    ...
    <div class="card shadow-sm border-0" style="border-radius: 1.5rem;">
                ...
                <div class="text-center mb-4">
                   ...
                   <form action="/grupobrasil/public/index.php?route=login/authenticate" method="POST" id="loginForm" novalidate>
                        ...
                        <button class="btn btn-lg btn-login text-uppercase fw-bold mb-2 rounded-pill" type="submit">
